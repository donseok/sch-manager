...
export async function POST() {
        try {
            ...
            // Create sample nurses with correct position codes (HN, CN, AN, RN)
            const nurses = [
                { employeeNumber: "N001", name: "김간호", position: "HN", positionRank: 1, sortOrder: 1 },
                { employeeNumber: "N002", name: "이간호", position: "CN", positionRank: 2, sortOrder: 2 },
                { employeeNumber: "N003", name: "박간호", position: "RN", positionRank: 4, sortOrder: 3 },
                { employeeNumber: "N004", name: "최간호", position: "RN", positionRank: 4, sortOrder: 4 },
                { employeeNumber: "N005", name: "정간호", position: "RN", positionRank: 4, sortOrder: 5 },
                        ];
